...
à la racine du dépôt). Toute la partie IA vit à la **racine du dépôt**, aussi les jobs Python se
placent en `working_directory: ~/project`.
...
### Reproduire chaque job en local (depuis la racine)
