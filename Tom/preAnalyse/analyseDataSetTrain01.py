...
@app.cell
def _(columns, pl):
    train = pl.read_csv("./assets/KaggleDataset/CMaps/train_FD001.txt", separator=" ", has_header=False, truncate_ragged_lines=True).drop(["column_27", "column_28"])
...
def _(sv, train_rul):
    ...
    reportCsvTrainNasa.show_html(filepath="./reports/reportCsvTrainNasa.html", open_browser=False)
...
@app.cell
def _(columns, pl):
    test = pl.read_csv("./assets/KaggleDataset/CMaps/test_FD001.txt", separator=" ", has_header=False, truncate_ragged_lines=True, ).drop(["column_27", "column_28"])

    test.columns = columns

    rul_true = pl.read_csv("./assets/KaggleDataset/CMaps/RUL_FD001.txt", separator=" ", has_header=False, truncate_ragged_lines=True)
