...
| [`tests.md`](07-ci-cd/tests.md) | **Stratégie de tests** : la suite de `tests/` fichier par fichier (rôle, niveau dans la pyramide, dépendances, job CI), les marqueurs (`@needs_models`, skip E2E), le lancement et la **couverture** (périmètre mesuré, exclusions). |
